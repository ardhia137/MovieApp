...
class DetailActivity : AppCompatActivity() {
    ...
    private fun showDetail(detail: Movie?) {
        detail?.let {
            ...
            binding.tvMovieRating.text = getString(R.string.movie_rating, detail.voteAverage)
            binding.tvMovieReleaseDate.text = getString(R.string.movie_release_date, detail.releaseDate)
